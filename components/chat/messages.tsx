...
export function UserMessage() {
  return (
    <MessagePrimitive.Root className="flex flex-col items-end gap-1">
      ...
      <div className="bg-primary text-primary-foreground max-w-[80%] min-w-0 rounded-2xl px-4 py-2.5 text-sm break-words">
...
export function AssistantMessage() {
  ...
  return (
    <MessagePrimitive.Root className="flex justify-start gap-3">
      ...
      <div className="bg-muted max-w-[85%] min-w-0 rounded-2xl px-4 py-2.5 text-sm break-words @2xl/chat-shell:max-w-[75%]">
